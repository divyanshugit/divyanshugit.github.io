...
references:
  ...
  3: https://arxiv.org/abs/2404.04392
---
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img src="/assets/img/llama_cpp.jpeg" alt="Llama.cpp" class="img-fluid rounded z-depth-1" loading="eager" />
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img src="/assets/img/response.png" alt="Model Response" class="img-fluid rounded z-depth-1" loading="eager" />
    </div>
</div>
...
- Llama.cpp[1]
- llama-cpp-python[2]
- Fine-Tuning, Quantization, and LLMs: Navigating Unintended Outcomes[3]
