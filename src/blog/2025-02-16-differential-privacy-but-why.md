...
references:
  ...
  3: https://www.helpnetsecurity.com/2024/10/31/miguel-guevara-google-implementing-differential-privacy/
  4: https://www.apple.com/privacy/docs/Differential_Privacy_Overview.pdf
  5: https://www.betterdata.ai/blogs/differentially-private-synthetic-healthcare-data-for-better-insights
  6: https://github.com/divyanshugit/Inception-of-DP
---

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img src="/assets/img/dp_blog/1.png" alt="Differential Privacy Introduction" class="img-fluid rounded z-depth-1" loading="eager" />
    </div>
</div>
