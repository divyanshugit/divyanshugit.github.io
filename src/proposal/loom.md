...
<li><strong>Best-of-N sampling.</strong> Generates N complete solutions and picks one. It wastes compute on the long confident prefix that all N samples agree on, and the picker is usually just majority vote, with no step-level signal about <em>where</em> a solution went wrong.</li>
</ul>
